...
//            getContent = getTextElement(driver, locator);
	...
	public void assignTask(String userAccount, String itemInListLocator) {
		...
		selectItemInCustomDropdownBySearching(driver, SvWlcCounterPageUI.ASSIGNED_DROP,
	...
	public boolean isSortDataInList() {
		if (isElementDisplayed(driver, SvWlcCounterPageUI.SOCIAL_ITEM_ALL_ITEM)) {
			return isNewListCompare(driver, SvWlcCounterPageUI.SOCIAL_ITEM_ALL_ITEM,
					SvWlcCounterPageUI.SOCIAL_ITEM_CONTENT_ALL_ITEM, SvWlcCounterPageUI.TAIL_UNANSWER_PIN_ITEM,
					SvWlcCounterPageUI.TAIL_ANSWERED_PIN_ITEM, SvWlcCounterPageUI.TAIL_UNANSWER_NO_PIN_ITEM,
