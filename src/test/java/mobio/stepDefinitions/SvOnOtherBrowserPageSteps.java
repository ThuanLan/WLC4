...
public class SvOnOtherBrowserPageSteps {
    ...
    public void openMobioOnSecondBrowser() {
        ...
        driverSecond.manage().timeouts().implicitlyWait(GlobalConstants.LONG_TIMEOUT, TimeUnit.SECONDS);
    }
    ...
    public void selectBehaviorTagName() {
        ...
        svWlcCounterPage.sendkeyToElement(driverSecond, SvWlcCounterPageUI.SEARCH_BEHAVIOR_TAG,
                GlobalConstants.BH_TAG_NAME);
        svWlcCounterPage.sleepInSecond(2);
        svWlcCounterPage.waitToElementVisible(driverSecond, SvWlcCounterPageUI.BEHAVIOR_TAG,
                GlobalConstants.BH_TAG_NAME);
        svWlcCounterPage.clickToElement(driverSecond, SvWlcCounterPageUI.BEHAVIOR_TAG,
                GlobalConstants.BH_TAG_NAME);
    }
